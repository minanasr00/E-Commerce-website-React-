...
export default function ProductCard({ product }) {
    ...
    return <>
        <div onClick={() => { navigate(`/products/${product.id}`) }} className=' font-[beatrice] col-span-12 md:col-span-4 lg:col-span-3 h-96 hover:scale-105 transition-all duration-300 ease-in-out '>
